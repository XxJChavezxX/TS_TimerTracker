...
public class ProfileActivity extends Activity {
	...
	private void SaveNewItem() {
		...
		if (id <= 0) {
			...
			// close this activity
			finish();
			Toast.makeText(this, "Your profile has been created successfully",
					Toast.LENGTH_LONG).show();

			finish();

		} else if (profile.getFirstName().equals(name)
			...
			Toast.makeText(this, "Your profile has been updated successfully",
					Toast.LENGTH_LONG).show();
